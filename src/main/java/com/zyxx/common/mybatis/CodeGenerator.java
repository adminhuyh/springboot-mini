...
public class CodeGenerator {
    ...
    // 开发人员
    private static final String AUTHOR = "lizhou";
    // 父包名
    private static final String PARENT = "com.zyxx";
    // 模块名
    ...
    public static void main(String[] args) {
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + XML_PATH + MODULENAME + "/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        });
        // 自定义输出文件
